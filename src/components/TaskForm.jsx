...
const TaskForm = (props) => {
  ...
  const handleExpand = (event) => {
    ...
    let expand = document.getElementById("task_form");
  ...
  const handleCreate = (title, description, date) => {
    if (title !== "") {
  ...
  return (
    <div>
      ...
      >
        ...
        <div
          id="task_detail"
          className={`task_detail ${active ? "active" : ""}`}
        >
          <div className="date">
            <svg
              width="18"
